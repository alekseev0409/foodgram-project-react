...
from .models import (
    Ingredient, Tag,
    Recipe, Favorite, IngredientInRecipe, ShoppingList,
)
from .serializers import (
    TagSerializer, IngredientSerializer,
    RecipeCreateSerializer, FavoriteSerializer, RecipeSerializer,
...
class RecipeViewSet(ModelViewSet):
    ...
    def favorite(self, request, pk=None):
        ...
        if request.method == 'DELETE':
            ...
            return Response({'detail': 'Рецепт из избранного удален.'},
